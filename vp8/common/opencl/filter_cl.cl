...
{
    private int FData[13*16];   /* Temp data bufffer used in filtering */
...
{
    private int FData[13*16];   /* Temp data buffer used in filtering */
...
{
    private int FData[21*24];   /* Temp data buffer used in filtering */
