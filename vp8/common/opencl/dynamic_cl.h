...
typedef cl_context(*fn_clCreateContextFromType)(const cl_context_properties *, cl_device_type, void (CL_CALLBACK * )(const char *, const void *, size_t, void *), void *, cl_int *);
...
typedef cl_mem(*fn_clCreateSubBuffer)(cl_mem, cl_mem_flags, cl_buffer_create_type, const void *, cl_int *);
...
typedef cl_int(*fn_clSetMemObjectDestructorCallback)( cl_mem,  void (CL_CALLBACK *),  void * ) ;
...
typedef cl_int(*fn_clBuildProgram)(cl_program, cl_uint, const cl_device_id *, const char *,  void (CL_CALLBACK *), void *);
...
typedef cl_event(*fn_clCreateUserEvent)(cl_context, cl_int *);
typedef cl_int(*fn_clRetainEvent)(cl_event);
typedef cl_int(*fn_clReleaseEvent)(cl_event);
typedef cl_int(*fn_clSetUserEventStatus)(cl_event, cl_int);
typedef cl_int(*fn_clSetEventCallback)(cl_event, cl_int, void (CL_CALLBACK *)(cl_event, cl_int, void *), void *);
...
typedef cl_int(*fn_clEnqueueReadBufferRect)(cl_command_queue, cl_mem, cl_bool, const size_t *, const size_t *,  const size_t *, size_t, size_t, size_t, size_t,  void *, cl_uint, const cl_event *, cl_event *);
...
typedef cl_int(*fn_clEnqueueWriteBufferRect)(cl_command_queue, cl_mem, cl_bool, const size_t *, const size_t *,  const size_t *, size_t, size_t, size_t, size_t,  const void *, cl_uint, const cl_event *, cl_event *);
...
typedef cl_int(*fn_clEnqueueCopyBufferRect)(cl_command_queue,  cl_mem, cl_mem,  const size_t *, const size_t *, const size_t *,  size_t, size_t, size_t, size_t, cl_uint, const cl_event *, cl_event *);
...
typedef struct CL_FUNCTIONS {
    ...
    fn_clCreateSubBuffer createSubBuffer;
    ...
    fn_clSetMemObjectDestructorCallback setMemObjectDestructorCallback;
    ...
    fn_clCreateUserEvent createUserEvent;
    fn_clRetainEvent retainEvent;
    fn_clReleaseEvent releaseEvent;
    fn_clSetUserEventStatus setUserEventStatus;
    fn_clSetEventCallback setEventCallback;
    fn_clGetEventProfilingInfo getEventProfilingInfo;
    fn_clFlush flush;
    fn_clFinish finish;
    fn_clEnqueueReadBuffer enqueueReadBuffer;
    fn_clEnqueueReadBufferRect enqueueReadBufferRect;
    fn_clEnqueueWriteBuffer enqueueWriteBuffer;
    fn_clEnqueueWriteBufferRect enqueueWriteBufferRect;
    fn_clEnqueueCopyBuffer enqueueCopyBuffer;
    fn_clEnqueueCopyBufferRect enqueueCopyBufferRect;
